class Heap:
    ...
    def has_greater_child(self, index):
        ...
        if left_child_exists and self.data[self.left_child_index(index)] > self.data[index] or right_child_exists and self.data[self.right_child_index(index)] > self.data[index]:
            return True
