...
def bfs_traverse(starting_vertex, search_vertex):
    queue = Queue()
    ...
    while queue.read():
        ...
        if current_vertex.value == search_vertex.value:
            print(f"We found the vertex with value {current_vertex.value}!")
